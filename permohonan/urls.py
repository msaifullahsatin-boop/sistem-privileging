...
urlpatterns = [
    ...
    path('pengarah/dashboard/', views.pengarah_dashboard, name='pengarah_dashboard'),
    ...
    path('pengarah/permohonan/<int:pk>/keputusan/', views.keputusan_pengarah, name='keputusan_pengarah'),
